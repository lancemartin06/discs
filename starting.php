...
?>
    ...
    <section class="content">
            <pre><h1>1. Learn the Technique</h1>
                    ...
                    to learn how their own body's style. Everyone is different and there
                    are many sizes and shapes of discs, so it may take time to find one that works for you.
    ...
    <section class="content">
            <pre><h1>2. Practice</h1>
                ...
                a good technique. If you have a hyperactive pup at home, this may be
                a great way to kill two birds with one stone.

                    Make sure to stretch before and after. Your rotator cuff is a beautiful
                thing and expensive to fix.
    ...
    <section class="content">
            <pre><h1>3. Play With Better Golfers</h1>
                ...
                general. You'll probably lose a lot, but you'll improve much quicker than
                playing alone.
    ...
    <section class="content">
            <pre><h1>4. Fewer Discs at First</h1>
                ...
                have developed your abilities. If you are playing with more experienced players,
                they are likely to have nice discs for you to try out anyway.
    ...
    <section class="content">
            <pre><h1>5. Have Fun.</h1>
                ...
                Also, take it easy around water features. If you do find yourself with a disc in
                the darkness of the pond, we'll be there to help you out! If you see us out there,
                feel free ask us to get your discs.
            </pre>
    </section>
